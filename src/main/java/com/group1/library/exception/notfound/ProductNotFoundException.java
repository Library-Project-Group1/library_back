...
/**
 * The {@code ProductNotFoundException} class is the class of errors and
 * exceptions when an {@code Product} instance could not be found in the
 ...
 *
 * For the purposes of compile-time checking of exceptions, {@code ProductNotFoundException}
 ...
 *
 * <p>The reason that a {@code ProductNotFoundException} may have a cause
 ...
 * It would be bad design to let the {@code ProductNotFoundException} thrown
 * by the lower layer propagate outward, as it is generally unrelated to the abstraction
 * provided by the upper layer.
 */
@ResponseStatus(value = HttpStatus.CONFLICT, reason = "This product was not found in the database.")
