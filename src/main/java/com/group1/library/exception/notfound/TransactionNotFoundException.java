...
/**
 * The {@code TransactionNotFoundException} class is the class of errors and
 * exceptions when an {@code Transaction} instance could not be found in the
 ...
 *
 * For the purposes of compile-time checking of exceptions, {@code TransactionNotFoundException}
 ...
 *
 * <p>The reason that a {@code TransactionNotFoundException} may have a cause
 ...
 * It would be bad design to let the {@code TransactionNotFoundException} thrown
 * by the lower layer propagate outward, as it is generally unrelated to the abstraction
 * provided by the upper layer.
 */
@ResponseStatus(value = HttpStatus.CONFLICT, reason = "This transaction was not found in the database.")
