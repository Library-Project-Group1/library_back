...
/**
 * The {@code ThemeNotFoundException} class is the class of errors and
 * exceptions when an {@code Theme} instance could not be found in the
 ...
 *
 * For the purposes of compile-time checking of exceptions, {@code ThemeNotFoundException}
 ...
 *
 * <p>The reason that a {@code ThemeNotFoundException} may have a cause
 ...
 * It would be bad design to let the {@code ThemeNotFoundException} thrown
 * by the lower layer propagate outward, as it is generally unrelated to the abstraction
 * provided by the upper layer.
 */
@ResponseStatus(value = HttpStatus.CONFLICT, reason ="This theme was not found in the database." )
