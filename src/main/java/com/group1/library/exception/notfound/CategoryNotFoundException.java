...
/**
 * The {@code CategoryNotFoundException} class is the class of errors and
 * exceptions when an {@code Category} instance could not be found in the
 ...
 *
 * For the purposes of compile-time checking of exceptions, {@code CategoryNotFoundException}
 ...
 *
 * <p>The reason that a {@code CategoryNotFoundException} may have a cause
 ...
 * It would be bad design to let the {@code CategoryNotFoundException} thrown
 * by the lower layer propagate outward, as it is generally unrelated to the abstraction
 * provided by the upper layer.
 */
@ResponseStatus(value = HttpStatus.CONFLICT, reason = "This category was not found in the database.")
