...
/**
 * The {@code ProductAlreadyExistException} class is the class of errors and
 * exceptions when an {@code Product} instance is already defined in the database.
 ...
 *
 * For the purposes of compile-time checking of exceptions, {@code ProductAlreadyExistException}
 ...
 *
 * <p>The reason that a {@code ProductAlreadyExistException} may have a cause
 ...
 * It would be bad design to let the {@code ProductAlreadyExistException} thrown
