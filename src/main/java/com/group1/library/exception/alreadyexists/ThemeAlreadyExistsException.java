...
/**
 * The {@code ThemeAlreadyExistsException} class is the class of errors and
 * exceptions when an {@code Theme} instance is already defined in the database.
 ...
 *
 * For the purposes of compile-time checking of exceptions, {@code ThemeAlreadyExistsException}
