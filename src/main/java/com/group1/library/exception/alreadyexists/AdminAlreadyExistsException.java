...
/**
 * The {@code AdminAlreadyExistsException} class is the class of errors and
 * exceptions when an {@code Admin} instance is already defined in the database.
 ...
 *
 * For the purposes of compile-time checking of exceptions, {@code AdminAlreadyExistsException}
 ...
 */
@ResponseStatus(value = HttpStatus.CONFLICT, reason = "This admin already exists in the database.")
