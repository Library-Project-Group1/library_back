...
/**
 * The {@code UserAlreadyExistsException} class is the class of errors and
 * exceptions when an {@code User} instance is already defined in the database.
 ...
 *
 * For the purposes of compile-time checking of exceptions, {@code UserAlreadyExistsException}
 ...
 *
 * <p>The reason that a {@code UserAlreadyExistsException} may have a cause
 ...
 * It would be bad design to let the {@code UserAlreadyExistsException} thrown
